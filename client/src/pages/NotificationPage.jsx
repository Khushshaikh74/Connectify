...
import { BellIcon, CameraIcon, ClockIcon, MessageSquareIcon, UserCheckIcon } from "lucide-react";
...
const NotificationsPage = () => {
  ...
  // console.log("a:", acceptedRequests);
                          ...
                          <div className="flex items-center gap-3">
                            <div className="avatar">
                              <div className="w-14 rounded-full bg-base-300">
                                <img
                                  src={request?.sender?.profilePic || <CameraIcon/>}
                        ...
                        <div className="flex items-start gap-3">
                          <div className="avatar mt-1">
                            <div className="w-10 rounded-full">
                              <img
                                src={notification?.recipient?.profilePic || "/fallback-avatar.png"}
