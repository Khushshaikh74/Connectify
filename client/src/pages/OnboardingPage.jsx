...
import { completeOnboard } from '../lib/api.js'
...
const OnboardingPage = () => {
  ...
  const handleRandomAvatar = () => {
    ...
    setOnboardData({ ...onboardData, profilePic: randomAvatar })
    toast.success("Random profile picture generated!")
  }

  const handleOnboardSubmit = (e) => {
    e.preventDefault()
    onboardMutation(onboardData)
  }
    ...
    <div className='min-h-screen bg-base-100 flex items-center justify-center p-4'>
      <div className='card bg-base-200 w-full max-w-3xl shadow-xl'>
        <div className='card-body p-6 sm:p-8'>
          ...
          <form className='space-y-6' onSubmit={handleOnboardSubmit}>
            <div className='flex flex-col items-center justify-center space-y-4'>
              {/* IMAGE PREVIEW */}
              <div className="size-32 rounded-full bg-base-300 overflow-hidden">
                {onboardData.profilePic ? (
                  <img
                    src={onboardData.profilePic}
                    alt="Profile Preview"
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) => setOnboardData({ ...onboardData, fullName: e.target.value })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-control">
                ...
                <select
                  ...
                  onChange={(e) => setOnboardData({ ...onboardData, nativeLanguage: e.target.value })}
              ...
              <div className="form-control">
                ...
                <select
                  ...
                  onChange={(e) => setOnboardData({ ...onboardData, learningLanguage: e.target.value })}
                  className="select select-bordered w-full"
                >
            ...
            <button className="btn btn-primary w-full" disabled={isPending} type="submit">
              {!isPending ? (
                <>
                  <Workflow className="size-5 mr-2" />
                  Complete Onboarding
                </>
              ) : (
                <>
